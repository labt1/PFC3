/* En términos generales, al definir funciones directamente en hpp, es mejor utilizar la modificación estática; 
   de lo contrario, se informará un error: "multiple definition of x" */
